...
export function SignUp() {
    ...
    async function handleSignUp(data: SignUpForm) {
        ...
        try {
            ...
            toast.success('Resrtaurante cadastrado com sucesso', {
                action: {
                    label: 'Login',
            ...
            <div className="p-8">
                ...
                <div className="w-[350px] flex flex-col justify-center gap-6">
                    ...
                    <form action="" className="space-y-4" onSubmit={handleSubmit(handleSignUp)}>
                        ...
                        <p className="px-5 text-center text-sm loading-relaxed text-muted-foreground">Ao continuar, você concorda com nossos<a className="underline underline-offset-4" href="#"> termos de serviço</a> e{' '} <a className="underline underline-offset-4" href="">políticas de privacidade.</a> </p>
                    </form>
                </div>
            </div>
        </>
